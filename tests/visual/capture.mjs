// Visual baseline for CSS refactors. Boots the real app in headless Edge/Chromium with a
// fixed date, a rich seeded state and a stubbed cloud, walks every screen, sheet and
// dialog in both themes at phone and desktop sizes, and saves for each one:
...
//
//   node tests/visual/capture.mjs --out <dir>
//   node tests/visual/compare.mjs <before-dir> <after-dir>
//
// Browser: PW_CHROMIUM_PATH, else the installed Microsoft Edge. Not part of `npm test`.
